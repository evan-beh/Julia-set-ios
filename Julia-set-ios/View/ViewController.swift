...
class ViewController: UIViewController, UIScrollViewDelegate {
    ...
    @IBOutlet weak var txtFieldY: UITextField!
    @IBOutlet weak var txtFieldX: UITextField!
...
//        self.scrollView.maximumZoomScale=6.0;
    ...
    @IBAction func buttonChangeValue(_ sender: Any) {
        ...
        if let updates = Float(self.txtFieldX.text ?? "0")
        {
        ...
        if let updates = Float(self.txtFieldY.text ?? "0")
        {
